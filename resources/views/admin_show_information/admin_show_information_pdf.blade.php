...
<body>
    ...
    <div class="container">
        <h4>คําร้องทั่วไป (พ่นหมอกควัน)</h4><br>
        ...
        <p style="margin-left: 55px; margin-top:10px;">ข้าพเจ้า <span class="fullname">{{ $form->fullname }}</span> อาย <span class="age">{{ $form->age }}</span>ปี อาชีพ<span class="occupation">{{ $form->occupation }}</span></p>
        ...
        <p style="margin-left: 55px;">ยื่นคําร้องต่อ<span class="submission">{{ $form->submission }}</span></p>
        <p>ด้วย ข้าพเจ้ามีความประสงค์ [ - ] พ่นหมอกควัน [ / ] ไม่พ่นหมอกควัน</p>
        <p>เนื่องจาก<span class="submission_name">{{ $form->submission_name }}</span></p>
